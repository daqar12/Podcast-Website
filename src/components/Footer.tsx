      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Stories That Resonate</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-xs">
              Conversations that drive deep into the heart of storytelling, creativity, and human connection.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/cookies" className="text-gray-400 hover:text-primary-red text-sm transition-colors">
              Cookie Policy
            </Link>
          </div>
        </div>
